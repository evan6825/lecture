...
,"KRW-DOGE"
,"KRW-MVL"
,"KRW-BTT" //btt는 계산이 이상하게되어서 구매하지않음.
,"KRW-CRE"
,"KRW-DKA"
...
async function buyAndSellWHILE_CANDEL(){ // 변동성전략을 이용한 구매하는 함수
    while(true){
        await sleep(1000*10)
        for (var i in _CANDLES){
            ...
            target_price = price+(high_price-low_price)*0.5//목표가
            ...
            if (target_price<price){
                ...
                body = await API_buyImmediate(market,300000)
